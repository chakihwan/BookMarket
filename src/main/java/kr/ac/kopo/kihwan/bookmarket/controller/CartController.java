...
import kr.ac.kopo.kihwan.bookmarket.domain.CartItem;
import kr.ac.kopo.kihwan.bookmarket.exception.BookIdException;
import kr.ac.kopo.kihwan.bookmarket.service.BookService;
import kr.ac.kopo.kihwan.bookmarket.service.CartService;
...
public class CartController {
    ...
    @ResponseStatus(value = HttpStatus.NO_CONTENT)
    public void removeCarByItem(@PathVariable("bookId") String bookId, HttpServletRequest request){
        String sessionId = request.getSession(true).getId();
        Cart cart = cartService.read(sessionId);
